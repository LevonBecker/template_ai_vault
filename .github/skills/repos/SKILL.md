---
name: repos
description: Use for showing this vault's related-repos map (org/repo list + template lineage) from properties.yml, or applying a change to all related repos. Equivalent to /repos. Also triggered by the phrases "related repos", "the repos", "other repos", or "all of the repos".
---
