---
name: ship-it
description: Use for pushing the current feature branch and opening a Pull Request in one step. Equivalent to /ship-it.
---
...
When the user asks to ship a branch end-to-end, read that prompt file and follow it.
