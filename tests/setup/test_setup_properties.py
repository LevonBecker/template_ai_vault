...
class TestIsTemplateRepo:
    ...
    def test_template_remote_is_a_template(self):
        assert setup_props._is_template_repo("github.com/LevonBecker/template_ai_vault")  # pylint: disable=protected-access

    def test_real_repo_remote_is_not_a_template(self):
        assert not setup_props._is_template_repo("github.com/LevonBecker/ai_vault")  # pylint: disable=protected-access
...
class TestSyncGitignoreTracking:
    ...
    def test_template_repo_leaves_gitignore_untouched(self, tmp_path, monkeypatch: pytest.MonkeyPatch):
        ...
        setup_props._sync_gitignore_tracking("github.com/LevonBecker/template_ai_vault")  # pylint: disable=protected-access
    ...
    def test_real_repo_strips_ignore_line_and_comment(self, tmp_path, monkeypatch: pytest.MonkeyPatch):
        ...
        gitignore.write_text(self._BLOCK)
        monkeypatch.setattr(setup_props, "_REPO_ROOT", tmp_path)
        setup_props._sync_gitignore_tracking("github.com/LevonBecker/ai_vault")  # pylint: disable=protected-access
