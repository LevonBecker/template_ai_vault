...
entries — see `.github/instructions/docs.instructions.md`.
"""
...
# Empty here — this repo has nothing versioned in properties.yml yet. A downstream repo adds its
# own category (e.g. "cloudformation", "lambda_functions") to this tuple once it has version-
# tracked entries to log; everything else in this module already supports it.
