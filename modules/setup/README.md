...
## What It Does
`properties.yml` is gitignored — machine-specific, never committed. `modules/setup/properties.py`:
...
`icloud.path` and `skeleton.*` can't be auto-detected and are left alone once the file exists — edit
