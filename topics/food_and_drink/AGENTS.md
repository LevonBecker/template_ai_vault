# your AI tool Instructions for Food And Drink
...
**Purpose**: working with Food And Drink
...
2. **Screenshots**: Type "ss" or "/ss" to examine the latest screenshot
   ...
   - **STEP 2**: Read `screenshots/latest.png` (only AFTER step 1 - otherwise you get a stale image)
